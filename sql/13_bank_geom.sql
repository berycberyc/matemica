...
with t as (
  insert into tasks (topic_ord, level, answer_type, stem_ru, stem_kk, answer_num, target_seconds, svg)
  values (602, 1, 'choice', 'В треугольнике два угла отмечены. Найди третий угол в градусах.', 'Үшбұрышта екі бұрыш белгіленген. Үшінші бұрышты градуспен тап.', 60.0, 60, '<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg" font-family="Onest, sans-serif" font-size="15"><polygon points="81.8,180.0 238.2,180.0 190.9,50.0" fill="#E6F0EE" stroke="#14302E" stroke-width="2" stroke-linejoin="round"/><path d="M 109.8 180.0 A 28 28 0 0 0 99.8 158.6" fill="none" stroke="#1F6F6B" stroke-width="2"/><path d="M 228.6 153.7 A 28 28 0 0 0 210.2 180.0" fill="none" stroke="#1F6F6B" stroke-width="2"/><text x="125.8" y="169.0" fill="#1F6F6B" text-anchor="middle" font-size="15">50°</text><text x="194.2" y="169.0" fill="#1F6F6B" text-anchor="middle" font-size="15">70°</text><text x="190.9" y="74.0" fill="#1F6F6B" text-anchor="middle" font-size="19">?</text><text x="68.8" y="186.0" fill="#14302E" text-anchor="middle" font-size="15">A</text><text x="251.2" y="186.0" fill="#14302E" text-anchor="middle" font-size="15">B</text><text x="190.9" y="40.0" fill="#14302E" text-anchor="middle" font-size="15">C</text></svg>') returning id
)
insert into options (task_id, pos, body, is_correct, error_code) values
...
with t as (
  insert into tasks (topic_ord, level, answer_type, stem_ru, stem_kk, answer_num, target_seconds, svg)
  values (602, 2, 'choice', 'В треугольнике два угла отмечены. Найди третий угол в градусах.', 'Үшбұрышта екі бұрыш белгіленген. Үшінші бұрышты градуспен тап.', 105.0, 90, '<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg" font-family="Onest, sans-serif" font-size="15"><polygon points="50.0,180.0 270.0,180.0 169.9,96.0" fill="#E6F0EE" stroke="#14302E" stroke-width="2" stroke-linejoin="round"/><path d="M 78.0 180.0 A 28 28 0 0 0 72.9 163.9" fill="none" stroke="#1F6F6B" stroke-width="2"/><path d="M 248.6 162.0 A 28 28 0 0 0 242.0 180.0" fill="none" stroke="#1F6F6B" stroke-width="2"/><text x="94.0" y="169.0" fill="#1F6F6B" text-anchor="middle" font-size="15">35°</text><text x="226.0" y="169.0" fill="#1F6F6B" text-anchor="middle" font-size="15">40°</text><text x="169.9" y="120.0" fill="#1F6F6B" text-anchor="middle" font-size="19">?</text><text x="37.0" y="186.0" fill="#14302E" text-anchor="middle" font-size="15">A</text><text x="283.0" y="186.0" fill="#14302E" text-anchor="middle" font-size="15">B</text><text x="169.9" y="86.0" fill="#14302E" text-anchor="middle" font-size="15">C</text></svg>') returning id
)
insert into options (task_id, pos, body, is_correct, error_code) values
...
with t as (
  insert into tasks (topic_ord, level, answer_type, stem_ru, stem_kk, answer_num, target_seconds, svg)
  values (602, 3, 'number', 'В треугольнике два угла отмечены. На сколько градусов наибольший угол треугольника больше наименьшего?', 'Үшбұрышта екі бұрыш белгіленген. Үшбұрыштың ең үлкен бұрышы ең кішісінен неше градусқа үлкен?', 40.0, 150, '<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg" font-family="Onest, sans-serif" font-size="15"><polygon points="111.0,180.0 209.0,180.0 133.9,50.0" fill="#E6F0EE" stroke="#14302E" stroke-width="2" stroke-linejoin="round"/><path d="M 139.0 180.0 A 28 28 0 0 0 115.9 152.4" fill="none" stroke="#1F6F6B" stroke-width="2"/><path d="M 195.0 155.8 A 28 28 0 0 0 181.0 180.0" fill="none" stroke="#1F6F6B" stroke-width="2"/><text x="155.0" y="169.0" fill="#1F6F6B" text-anchor="middle" font-size="15">80°</text><text x="165.0" y="169.0" fill="#1F6F6B" text-anchor="middle" font-size="15">60°</text><text x="133.9" y="74.0" fill="#1F6F6B" text-anchor="middle" font-size="19">?</text><text x="98.0" y="186.0" fill="#14302E" text-anchor="middle" font-size="15">A</text><text x="222.0" y="186.0" fill="#14302E" text-anchor="middle" font-size="15">B</text><text x="133.9" y="40.0" fill="#14302E" text-anchor="middle" font-size="15">C</text></svg>') returning id
)
select id from t;
